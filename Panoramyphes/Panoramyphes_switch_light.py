...
# To change calibration: line 807 
...
class TisCameraWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, app):
        ...
        self.set_default_size(2448, 2048) # tile size (px)
    ...
    def reduce_images(self, folder, index, nb_img):
        ...
        for img in images[index:index+nb_img]:
            ...
            small = cv2.resize(im1, None, fx=1, fy=1, interpolation=cv2.INTER_CUBIC)
