...
exp_path = '/home/hyphes/Clara/2019/2019_11_05_P_S_M24x/outputMovie/regMovie_50_60.tif' 
# absolute path of the binarized images tack 
bin_path = '/home/hyphes/Clara/2019/2019_11_05_P_S_M24x/outputMovie/bin_FFT_regMovie_50_60.tif' 
# absolute path of the directory where the results will be stored in
dest_path = '/home/hyphes/Clara/2019/2019_11_05_P_S_M24x/VST_50_60'
...
doStack = True # True to create a stack (slow)
...
line_color = (0, 0, 0) 
line_size = 1
apex_color = (70, 26, 244) 
apex_size = 5
node_color = (0, 204, 255) 
node_size = 5
body_color = (178, 55, 164) 
body_size = 3
