...
def init():
    ...
    # General parameters
    exp_path = '/home/hyphes/LAURA/stacks_tif/1705_binarizedMovie_1_6.tif' # experimental tif stack (grayscale)
    bin_path = '/home/hyphes/LAURA/stacks_tif/1705_binarizedMovie_1_6.tif' # binarized tif stack
    vect_path = '/home/hyphes/LAURA/Test_0910/vect' # gpickle directory
    dest_path = '/home/hyphes/LAURA/Test_0910/sup' # output directory
    verbose = True
    debug = True
    invert = True 
...
def overlay(main_params, output_params, drawing_params, manual_log_path=''):
    ...
    if doStack:         
        ...
        with tifffile.TiffWriter(destination,bigtiff=True) as tiff:
            ...
            for i, frame in enumerate(tqdm(frames, total=len(frames), desc=desc,
                ...
                tiff.write(frame, compression=True)
