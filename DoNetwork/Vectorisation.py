...
def init():
    ...
    # General parameters        
    source_path = '/home/hyphes/Thibault/LED/FinalBinarizedCorrected.tif' # directory or image to vectorize
    dest_path = '/home/hyphes/Thibault/LED' # output directory
    unstack = False  # saves each slice as a separated image
    verbose = True 
    debug = False
    invert = False # inverts the images before processing                                                       
